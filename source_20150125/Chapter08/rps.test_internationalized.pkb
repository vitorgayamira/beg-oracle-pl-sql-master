 ...
 */
 ...
 'Is the length of v_TEST_60 equal to 30?');
 if nvl(length(v_TEST_60), 0) = 30 then
 ok();
 else
 error();
 end if;
 ...
 'Is the length of v_TEST_60_1 equal to 30?');
 if nvl(length(v_TEST_60_1), 0) = 30 then
 ok();
 else
 error();
 end if;
 ...
 'Is the length of v_TEST_60_2 equal to 30?');
 if nvl(length(v_TEST_60_2), 0) = 30 then
 ok();
 else
 error();
 end if;
 ...
 'Is the length of v_TEST_160 equal to 80?');
 if nvl(length(v_TEST_160), 0) = 80 then
 ok();
 else
 error();
 end if;
 ...
 'Is the length of v_TEST_200 equal to 100?');
 if nvl(length(v_TEST_200), 0) = 100 then
 ok();
 else
 error();
 end if;
 ...
 'Is the length of v_TEST_4000 equal to 2000?');
 if nvl(length(v_TEST_4000), 0) = 2000 then
 ok();
 else
 error();
 end if;

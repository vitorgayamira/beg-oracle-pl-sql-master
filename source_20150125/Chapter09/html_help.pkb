 ...
 */
 ...
 &_USER..TEST.clear('HTML_HELP');

 &_USER..TEST.set_test('HTML_HELP', 'create_package_index()', 1,
 ...
 &_USER..TEST.set_test('HTML_HELP', 'create_package_help()', 2,
 ...
 &_USER..TEST.set_test('HTML_HELP', 'help()', 3,
 'Test method help()' );
 begin
 help();
 ...
 &_USER..TEST.set_test('HTML_HELP', NULL, NULL, NULL);
 &_USER..TEST.success();
 end test;
